...
const Contact = () => {
  ...
  return (
    <>
      {/* <!-- ===== Contact Start ===== --> */}
      <section id="contact" className="relative px-4 md:px-8 2xl:px-0">
          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>Block 2, Web3Bridge Wagmi Headquarters</p>
              </div>
              <div className="5 mb-7">
                <h3 className="text-metatitle3 mb-4 font-medium text-black dark:text-white">
                  Email Address
                ...
                <p>
                  <a href="#">WagmiHq@domainname.com</a>
                </p>
              </div>
              <div>
