...
const FunFact = () => {
  return (
    <>
      {/* <!-- ===== Funfact Start ===== --> */}
      <section id="stats" className="px-4 py-20 md:px-8 lg:py-22.5 2xl:px-0">
        <div className="max-w-c-1390 dark:bg-blacksection dark:stroke-strokedark relative z-1 mx-auto rounded-lg bg-linear-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 xl:py-27.5 dark:bg-linear-to-t dark:from-transparent dark:to-transparent">
          ...
          >
            ...
            <p className="mx-auto lg:w-11/12">
              Companies worldwide trust StreamPay to provide their employees
              with instant salary access. Join the growing number of progressive
              employers offering this essential financial benefit.
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="lg:text-para2 text-lg">Active Users</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="lg:text-para2 text-lg">Streamed in Salaries</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="lg:text-para2 text-lg">Partner Companies</p>
            </motion.div>
          </div>
        </div>
      </section>
